...
public class MergeSort implements SortingStrategy {
    ...
    private static <E extends Comparable<E>> List<E> merge(List<E> array1, List<E> array2, Comparator<E> comparator) {
    ...
    public <E extends Comparable<E>> List<E> sort(List<E> list, Comparator<E> comparator) {
        ...
        int mid = list.size() / 2;
        List<E> left = sort(list.subList(0, mid), comparator);
        List<E> right = sort(list.subList(mid, list.size()),  comparator);
        List<E> merged = merge(left, right, comparator);
